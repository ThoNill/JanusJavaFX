...
public class JavaFXGuiElementBuilder implements GuiElementBuilder {
    ...
    private GuiComponent createGuiElementIntern(Element elem, Action a) {
        ...
        case MENUITEM:
            return new MenuItemConnector(
                    new MenuItem(getTextFromElement(elem)), a);
        case POPUP:
     ...
     * SwingAttributSetter setter) { String xmlValue =
     * elem.getAttributeValue(field.name().toLowerCase()); if (xmlValue != null)
